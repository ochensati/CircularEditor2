    ...
    public class LorenI : aVowel
    {
        ...
        protected override void CalcVowel(System.Drawing.Rectangle VowelBounds, double vX, double vY, double vR)
        {
            ...
            try
            {
                ...
                {
                    _ControlPoints = new Point[] { MathHelps.D2Coords(new Point((int)vX, (int)vY), vR, _Syllable.MidAngle + 180), MathHelps.D2Coords(new Point((int)vX, (int)vY), 2*vR, _Syllable.MidAngle + 180) };
                    Anchors.Add("LineI", new DecorationAnchor(new Point[] { _ControlPoints[1] }, .2, 2, this));
                }
